...
final class HomeRegisterViewController: BaseViewController<HomeRegisterViewModel> {
    ...
    private func setupUI() {
        ...
        titleLabel.attributedText = AtchaFont.H2_B_22("우리 집을 등록해 보세요", color: AtchaColor.white)
        subTitleLabel.attributedText = AtchaFont.B4_R_15("출발지에서 우리집까지 빠르게 막차 찾을 수 있어요.", color: AtchaColor.gray200)
    ...
    private func setupNoneStateUI() {
        ...
        searchLocationLabel.attributedText = AtchaFont.B1_R_17("지번, 도로명, 건물명으로 검색", color: AtchaColor.gray400)
