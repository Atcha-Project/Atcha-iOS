...
class WithdrawViewController: BaseViewController<WithdrawViewModel> {
    ...
    private lazy var withdrawButton: AtchaButton = AtchaButton(text: "탈퇴하기", size: .h52, style: .filled(.disabled)) {
        
    }
    private let withdrawTextBox: WithDrawTextBox = AtchaTextBox.withDrawTextBox { String in
